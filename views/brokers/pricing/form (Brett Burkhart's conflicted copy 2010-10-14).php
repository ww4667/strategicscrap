...
<?php } ?>
	...
	<form method="post" id="price_form">
		<ul class="form user">
			<li><strong>Mr. Jonathan Broker:</strong><input type="hidden" name="name" /><br />Broker Company<input type="hidden" name="company" /></li>
		</ul>
		<hr />
		...
		<ul class="form materials">
			<li><label>#1 HMS:</label><input class="w1" type="text" name="qty[0]" /></li>
			<li><label>#2 HMS:</label><input class="w1" type="text" name="qty[1]" /></li>
			<li><label>MST:</label><input class="w1" type="text" name="qty[2]" /></li>
			<li><label>Shredded:</label><input class="w1" type="text" name="qty[3]" /></li>
			<li><label>#2 Bundles:</label><input class="w1" type="text" name="qty[4]" /></li>
		</ul>
		<br />
