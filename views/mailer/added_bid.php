		...
		<h2><strong><?=$object['fname']?>, you have a new transportation bid request.</strong><br></h2>
          <table width="95%" border="0" cellspacing="0" cellpadding="10">
            <tr>
              <td bgcolor="#F5F5F5" style="background-color:#F5F5F5;font-size:12px;font-family:Arial, Helvetica, sans-serif;line-height:20px;color:#666">
				<!--BODY CONTENT START-->
				 <p><a href="https://strategicscrap.com">Click Here</a> to login to your account and view your unread bid.</p>
				<!--BODY CONTENT END-->
				</td>
              </tr>
          </table>
