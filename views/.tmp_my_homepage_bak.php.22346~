				<div class="leftCol">
						...
						<div id="regionalPricing" class="oneColMod"><div class="moduleTop"><!-- IE hates empty elements --></div>
							<div class="moduleContent">
								...
								<table>
									...
									<tr>
									    <td>Plate and Structural, < 5 ft.</td>
									    <td>416.00</td>
									</tr>
									<tr class="row2">
					...
					<div class="upperRightCol">
						<div id="transportAverages" class="oneColMod"><div class="moduleTop"><!-- IE hates empty elements --></div>
							<div class="moduleContent">
								...
								<table>
									...
									<tr>
									    <td>Gondola/Open Top</td>
									    <td>X.XX</td>
									</tr>
									<tr class="row2">
									    <td>Export Containers</td>
									    <td>X.XX</td>
									</tr>
						...
						<div id="localWeather" class="oneColMod"><div class="moduleTop"><!-- IE hates empty elements --></div>
							<div class="moduleContent">
								...
								<strong>Feels Like: <?=$weather->cc->flik?></strong><br /><br />
								<strong>Wind: From <?=$weather->cc->wind->t?> at <?=$weather->cc->wind->s?>mph</strong><br /><br />
					...
					<div id="mainAd1" class="mcAd"><img src="resources/images/ad/advertise_here.png" /></div>
					<div class="lowerArea">
...
//]]>--></script><noscript><a href='http://www.strategicscrap.com/openads/www/delivery/ck.php?n=a64c18ab&amp;cb=INSERT_RANDOM_NUMBER_HERE' target='_blank'><img src='http://www.strategicscrap.com/openads/www/delivery/avw.php?zoneid=5&amp;n=a64c18ab' border='0' alt='' /></a></noscript>
					...
					<div id="latestNews" class="oneColMod"><div class="moduleTop"><!-- IE hates empty elements --></div>
						...
						<hr />
					  	<ul id="tabs-news">
							<li><a href="#tab1"><span>Business</span></a></li>
							<li><a href="#tab2"><span>Scrap</span></a></li>
						</ul>
						<div class="tabBox">
							<div id="tab1">
								<div id="scroll-pane1">
									<?
									foreach ($business_feed as $item) {
									$dc = $item->children('http://purl.org/dc/elements/1.1/');
									?>
									<div class="newsItem">
										<a href="<?=$item->link?>" target="_blank"><?=$item->title?></a>
										<?=date('D M d, Y',strtotime($item->pubDate))?><br />
										From <?=$dc->creator?>
									</div>
									<?
									}
