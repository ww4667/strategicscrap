  ...
  $(document).ready(function() {
   ...
   sw.tabOneSlider = new sw.app.verticalSlider('#tab-1', '#tab-1-pane','#tab-1-content',{overflow: "hidden", float: "left", height: "559px", width: "547px"}, {position: "relative"} );
   sw.tabTwoSlider = new sw.app.verticalSlider('#tab-2', '#tab-2-pane','#tab-2-content',{overflow: "hidden", float: "left", height: "559px", width: "547px"}, {position: "relative"} );    
   sw.tabOneSlider = new sw.app.verticalSlider('#tab-3', '#tab-3-pane','#tab-3-content',{overflow: "hidden", float: "left", height: "559px", width: "547px"}, {position: "relative"} );
   sw.tabTwoSlider = new sw.app.verticalSlider('#tab-4', '#tab-4-pane','#tab-4-content',{overflow: "hidden", float: "left", height: "559px", width: "547px"}, {position: "relative"} );
