...
<div class="sectionHeader">Updating Category ID: <?= $category->id ?></div>
<div class="sectionBody order_details">
	...
	foreach( $allCategoryObjects as $categoryObject ){
		...
		$categoryListOp .= '<option value="' . $categoryObject['id'] . '" ' . ( $categoryObject['id'] == $category->join_category_parent ? 'selected="selected"' : "" ) . '>' . $categoryObject['name'] . '</option>';
